...
from mic.click_encapsulate.commands import start, trace, config_files, parameters
...
encapsulate.add_command(parameters)
encapsulate.add_command(config_files)
#encapsulate.add_command(test)
